...
@section('page_title', 'Buat Kelas Baru')
...
<form action="{{ route('admin.classrooms.store') }}" method="POST">
    ...
    <div class="card" style="max-width: 800px;">
        ...
        <div class="form-group">
            ...
            <select name="academic_year_id" id="academic_year_id" class="form-select" required>
                @foreach($academicYears as $ay)
                    <option value="{{ $ay->id }}" {{ old('academic_year_id') == $ay->id || ($ay->is_active && !old('academic_year_id')) ? 'selected' : '' }}>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select name="class_id" id="class_id" class="form-select" required>
                    <option value="" disabled selected>-- Pilih Nama Rombel --</option>
        ...
        <div style="display: flex; gap: 1rem; margin-top: 2rem;">
            <button type="submit" class="btn btn-primary">Buat Kelas Baru</button>
