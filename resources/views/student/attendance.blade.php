...
@section('nav')
    @include('student.nav', ['active' => 'attendance'])
@endsection
...
<div class="flex-between" style="margin-bottom: 1.5rem;">
    <div>
        <p style="color: var(--on-surface-variant); font-size: 14px;">
            Pantau tingkat kehadiran Anda pada semester aktif ini. Klik panah navigasi untuk melihat riwayat absensi bulan lain.
        </p>
    </div>
</div>

{{-- Attendance Statistics Summary (Semester All-Time) --}}
    ...
    <div class="calendar-card">
        <div class="calendar-ctrl-header">
            ...
            <div class="calendar-nav-buttons">
                <a href="{{ route('student.attendance', ['year' => $prevYear, 'month' => $prevMonth]) }}" class="calendar-nav-btn" title="Bulan Sebelumnya">
                    &larr;
                </a>
                <a href="{{ route('student.attendance', ['year' => $nextYear, 'month' => $nextMonth]) }}" class="calendar-nav-btn" title="Bulan Berikutnya">
                    &rarr;
                </a>
            </div>
        </div>
