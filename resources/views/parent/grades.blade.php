...
@section('title', 'Rapor Belajar Anak')
@section('page_title', 'Rapor Belajar Anak')

@section('nav')
    @include('parent.nav', ['active' => 'grades'])
@endsection
...
<div class="flex-between" style="margin-bottom: 1.5rem;">
    <div>
        <p style="color: var(--on-surface-variant); font-size: 14px;">
            Berikut adalah laporan hasil belajar resmi untuk anak Anda: <strong>{{ $student->user->full_name }}</strong>.
        </p>
    </div>
</div>
...
@if($gradesByYear->isEmpty())
    <div class="card" style="padding: 3rem 1.5rem; text-align: center; color: var(--on-surface-variant);">
        ...
        <p style="font-size: 14px;">Belum ada rekaman nilai rapor resmi untuk anak Anda pada sistem Akademix.</p>
    </div>
@else
