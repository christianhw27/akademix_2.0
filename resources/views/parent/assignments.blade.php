...
@section('title', 'Tugas & Evaluasi Anak')
@section('page_title', 'Tugas & Evaluasi Anak')

@section('nav')
    @include('parent.nav', ['active' => 'assignments'])
@endsection
...
<div class="flex-between" style="margin-bottom: 1.5rem;">
    <div>
        <p style="color: var(--on-surface-variant); font-size: 14px;">
            Memantau materi pembelajaran dan status pengerjaan tugas dari anak Anda: <strong>{{ $student->user->full_name }}</strong>.
        </p>
    </div>
</div>
...
@if($subjects->isEmpty())
    <div class="card" style="padding: 3rem 1.5rem; text-align: center; color: var(--on-surface-variant);">
        ...
        <p style="font-size: 14px;">Belum ada jadwal mata pelajaran atau materi untuk kelas anak Anda saat ini.</p>
    </div>
@else
    <div class="split-layout">
        ...
        <div class="right-pane">
            ...
            <div class="empty-pane-state" id="empty-state">
                ...
                <p>Klik salah satu mata pelajaran di sebelah kiri untuk melihat materi dan tugas anak Anda.</p>
            </div>
                                ...
                                @foreach($subject->materials as $material)
                                    <div class="item-card">
                                        ...
                                        <div class="item-body">
                                            ...
                                            <p class="item-desc">{{ Str::limit(strip_tags($material->content), 160) }}</p>
                                            <div class="item-meta">
                                ...
                                @foreach($subject->assignments as $assignment)
                                    ...
                                    <div class="item-card">
                                        ...
                                        <div class="item-body">
                                            ...
                                            @if($sub && $sub->status === 'reviewed' && $sub->feedback)
